...
public class GuiNewOptionsRowList extends GuiListExtended {
    
    private final List<GuiNewOptionsRowList.Row> options = Lists.newArrayList();
    ...
    public GuiNewOptionsRowList(Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options... p_i45015_7_) {
        ...
        for(int i = 0; i < p_i45015_7_.length; i += 2) {
            ...
            this.options.add(new GuiNewOptionsRowList.Row(guibutton, guibutton1));
        }
    }
     ...
     */
    public GuiNewOptionsRowList.Row getListEntry(int index) {
